...
<body>
	<c:if test="${!empty pagedListHolder}">
		<c:url value="defectWorkflowList.html" var="pagedLink">
		...
		<div class="hero-unit span12"
			...
			<table class="table table-striped">
				...
				<thead>
					...
					<tr>
						<td colspan="2"
							style="font-family: 'Helvetica', Arial, sans-serif; font-size: 10pt; font-weight: bold;">List
							of Issues</td>
						<td colspan="10">
							...
							<tr>
								...
								<c:if
									...
									<td><a class="btn btn-info btn-small"
										href="defectFlow.html?id=${itwTaskBug.id}">View</a></td>
								</c:if>
								<c:if
									test="${itwTaskBug.currentloggedinuserid != itwTaskBug.assigneeiddisplay}">
