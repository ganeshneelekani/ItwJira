...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="saveItwChartStatus.html"
				enctype="multipart/form-data">

				<p
					style="font-family: 'Helvetica', Arial, sans-serif; font-size: 14pt; font-weight: bold;">
					<spring:message code="title.ListofChartStatus" text="default text" />
				</p>
				<table
					style="font-family: 'Helvetica', Arial, sans-serif; font-size: 10pt;">

					<tr>
						<td align="left"><spring:message code="title.ChartStatus" text="default text" /></td>
						<td>&nbsp;</td>
						<td><form:input path="shortname"
								value="${itwChartStatus.shortname}" placeholder="Enter Chart Status" /></td>
				...
				<input type="submit" class="btn btn-success btn-small"
					value="Save PlatForm" />
				<a class="btn btn-danger btn-small" href="addItwChartStatus.html">Reset</a>
