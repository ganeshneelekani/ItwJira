		...
		<div class="hero-unit span12"
			...
			<table class="table table-striped">
				...
				<thead>
					...
					<b>View Issue ${taskId1} History </b>
					<a href="editItwTaskBug1.html?id=${taskId1}&&projectId=${projectId}">Back To Issue ${taskId1} </a> 
				   </p> 
					</td>
						<c:if test="${!empty pagedListHolder}">
					...
					<c:if test="${!empty pagedListHolder}">
						<c:forEach items="${pagedListHolder.pageList}" var="itwTaskBugAudit">
							<tr>
								...
								<td><c:out value="${itwTaskBugAudit.lastupdatedbydisplay}" /></td>
								<td><c:out value="${itwTaskBugAudit.lastupdatedtime}" /></td>
