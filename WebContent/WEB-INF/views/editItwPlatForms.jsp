...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="updateItwPlatForms.html"
				...
				<table
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td><form:input path="id" value="${itwPlatForms.id}"
					...
					<tr>
						...
						<td><form:input path="shortname"
								value="${itwPlatForms.shortname}" placeholder="Enter PlatForm Name" /></td>
