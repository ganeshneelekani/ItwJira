...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="saveItwCompany.html"
				enctype="multipart/form-data">
				
				<p style="font-family: 'Helvetica', Arial, sans-serif; font-size: 10pt; font-weight: bold;">
				Create Company</p>
				<table style="font-family: 'Helvetica', Arial, sans-serif; font-size: 8pt;">
					<tr>
				...
				<input type="submit" class="btn btn-success btn-small"
					value="Save Company" />
				<a class="btn btn-danger btn-small" href="addItwCompany.html">Reset</a>
