	...
	<div class="container-fluid" style="padding-left: 0;">
		...
		<div class="hero-unit span3"
			...
			<form:form method="POST" action="j_spring_security_check">
				...
				<spring:message code="signin.enter.email" var="var_enter_email" />
				<form:input path="j_username" value="${SPRING_SECURITY_LAST_USERNAME}"
					placeholder="${var_enter_email}" style="width: 96%;" />
				<br>
				<!-- <form:input path="userid" value="${userLogin.userid}"
						placeholder="Enter Email Id" style="width: 96%;" /> -->

				<spring:message code="signin.enter.password"
					var="var_enter_password" />
				<form:password path="j_password" value="${userLogin.password}"
					placeholder="${var_enter_password}"  onpaste="return false;"
					style="float:left; margin-right: 6px; width: 254px;" />
					
				<spring:message code="signin" var="var_signin" />
					
				<input type="submit" class="btn btn-info btn-small"
					value="${var_signin}" style="float: left; padding: 5.6px 10px; position: relative; top: 1px; font-size: 12px" />
				
					
				<br>
			</form:form><a href="forgotPass.html">&nbsp;Forgot Password</a>
		</div>
	</div>
