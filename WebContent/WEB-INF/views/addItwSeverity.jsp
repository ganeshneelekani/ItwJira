...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="saveItwSeverity.html">

				<p
					style="font-family: 'Lucida Grande', Helvetica, Arial, sans-serif; font-size: 10pt; font-weight: bold;">
					Create New Severity</p>
				<table
					style="font-family: 'Lucida Grande', Helvetica, Arial, sans-serif; font-size: 8pt;">


					<tr>
						<td align="left" valign="top">Severity Name</td>
					...
					<td align="left" valign="top">Color</td>
						...
						<td><form:select path="colourCodeId"
								value="${itwSeverityBean.colourCodeId}">
								<form:option value="0" label="Select Colour" />
								<c:set var="severityiddisplaytemp">${itwSeverityBean.colourCodeId}</c:set>
								<c:forEach items="${itwSeverityBean.itwcolorcodeidList}"
									var="itwcolorcodeidlist">
									<c:choose>
										<c:when test="${itwcolorcodeidlist.id == severityiddisplaytemp}">
				...
				<input type="submit" class="btn btn-success btn-small"
					value="Save Severity" />
				<a class="btn btn-danger btn-small" href="addItwSeverity.html">Reset</a>
