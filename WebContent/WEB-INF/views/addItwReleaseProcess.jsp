...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="saveItwReleaseProcess.html"
				enctype="multipart/form-data" >

				<p
					style="font-family: 'Helvetica', Arial, sans-serif; font-size: 10pt; font-weight: bold;">
					<spring:message
								code="ReleaseProcess.CreateReleaseProcess" text="Enter Description" /></p>
				<table
					style="font-family: 'Helvetica', Arial, sans-serif; font-size: 8pt;">
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td><form:input path="step" value="${itwReleaseProcess.step}"
...
<tr>
						...
						<td><form:input path="langId"
								value="${itwReleaseProcess.langId}"
								type="hidden" /></td>
						<td><form:errors path="langId" cssClass="error"
								type="hidden" /></td>
				...
				<input type="submit" class="btn btn-success btn-small"
					value="Save Itw Release Process" />
				<a class="btn btn-danger btn-small" href="addItwReleaseProcess.html">Reset</a>
				<a class="btn btn-primary btn-small" href="itwReleaseProcessConfigList.html">Back</a>
			</form:form>
		</div>
	</div>
