...
<body>
	...
	<div class="container-fluid">
		<div class="hero-unit span12"
			...
			<form:form method="POST" action="saveItwReleases.html"
				...
				<table
					...
					<tr>
						...
						<td><form:input path="shortname"
								value="${itwReleases.shortname}"
								placeholder="Enter Release Name" /></td>
					...
					<tr>
						<td align="left"><spring:message
								code="ReleaseDocument.releasedescription"
								text="Release Description" /></td>
						<td>&nbsp;</td>
						<td><form:textarea path="releasedescription"
								value="${itwReleases.releasedescription}"
				...
				<input type="submit" class="btn btn-success btn-small"
					value="Save Release" />
				<a class="btn btn-danger btn-small" href="addItwReleases.html">Reset</a>
				<a class="btn btn-primary btn-small"
					href="itwReleasesConfigList.html">Back</a>
			</form:form>
		</div>
	</div>
